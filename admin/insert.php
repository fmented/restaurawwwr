...
if (!empty($_POST)) {
    ...
    if (empty($description)) {
        $descriptionError = 'Field tidak boleh kosong';
        $isSuccess = false;
    }
    if (empty($price)) {
        $priceError = 'Field tidak boleh kosong';
        $isSuccess = false;
    }
    if (empty($category)) {
        $categoryError = 'Field tidak boleh kosong';
        $isSuccess = false;
    }
    if (empty($image)) {
        $imageError = 'Field tidak boleh kosong';
        $isSuccess = false;
    } else {
        $isUploadSuccess = true;
        if ($imageExtension != "jpg" && $imageExtension != "png" && $imageExtension != "jpeg") {
            $imageError = "Format yang didukung: .jpg, .jpeg, .png";
            $isUploadSuccess = false;
        }
